...
CREATE TABLE IF NOT EXISTS `class` (
  ...
  `endTime` TIME NULL,
  PRIMARY KEY (`classNo`),
  INDEX `fk_class_staff_idx` (`staffID` ASC),
...
CREATE TABLE IF NOT EXISTS `assignment` (
  ...
  INDEX `fk_assignment_class1_idx` (`classNo` ASC),
...
CREATE TABLE IF NOT EXISTS `grade` (
  ...
  `maxScore` INT NULL,
  PRIMARY KEY (`gradeID`),
  INDEX `fk_assignment_has_student_student1_idx` (`studentID` ASC),
  INDEX `fk_assignment_has_student_assignment1_idx` (`assignmentID` ASC),
...
CREATE TABLE IF NOT EXISTS `billing` (
  ...
  INDEX `fk_billing_parent1_idx` (`parentID` ASC),
...
CREATE TABLE IF NOT EXISTS `report` (
  ...
  INDEX `fk_class_has_student_student1_idx` (`studentID` ASC),
  INDEX `fk_class_has_student_class1_idx` (`classNo` ASC),
...
CREATE TABLE IF NOT EXISTS `calendar` (
  ...
  `parentID` INT NOT NULL,
  PRIMARY KEY (`eventNo`),
  INDEX `fk_calendar_staff1_idx` (`staffID` ASC),
  INDEX `fk_calendar_parent1_idx` (`parentID` ASC),
